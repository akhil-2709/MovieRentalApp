...
namespace MovieRentalApp.Server.Migrations
{
    ...
    [Migration("20231126051045_NewVariants")]
    partial class NewVariants
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieRentalApp.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieRentalApp.Shared.OrderItem", b =>
                {
                    ...
                    b.HasKey("OrderId", "MovieId", "MovieTypeId");
            ...
            modelBuilder.Entity("MovieRentalApp.Shared.OrderItem", b =>
                {
                    ...
                    b.HasOne("MovieRentalApp.Shared.Order", "Order")
                        .WithMany("OrderItems")
